...
import com.yzf.king.present.PUploadBankCardDiy;
 ...
 * FixDescription：
 */
public class UploadBankCardDiyActivity extends XActivity<PUploadBankCardDiy> {
    ...
    public int getLayoutId() {
        return R.layout.activity_upload_bankcard_diy;
    }

    @Override
    public PUploadBankCardDiy newP() {
        return new PUploadBankCardDiy();
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.ulbankcard_confirm_bt:
                ...
                if (flag) {
                    ...
                    getP().cardOperate(AppUser.getInstance().getMerchId(), "1", cardNo, name, phoneNo, idNo);
                }
                break;
                default:
        }
