...
import com.yzf.king.present.PUploadFaceDiy;
 ...
 * FixDescription：
 */
public class UploadFaceDiyActivity extends XActivity<PUploadFaceDiy> {
    @BindView(R.id.title)
    TextView title;
    ...
    public int getLayoutId() {
        return R.layout.activity_upload_face_diy;
    }

    @Override
    public PUploadFaceDiy newP() {
        return new PUploadFaceDiy();
    }
    ...
    @OnClick({R.id.ulface_iv, R.id.ulface_cap_iv, R.id.ulface_confirm_bt})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.ulface_iv:
            case R.id.ulface_cap_iv:
                mCount = FACE;
                choosePicture(mMobile + "_FACE");
                break;
            case R.id.ulface_confirm_bt:
                ...
                if (flag) {
                    ...
                    getP().kayouIncome(AppUser.getInstance().getMerchId());
                }
                break;
        }
    }
