...
public class OrderActivity extends XActivity {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        initView();
        fragmentList.clear();
//        fragmentList.add(OrderFragment.newInstance(null));
        fragmentList.add(OrderFragment.newInstance("1"));
        fragmentList.add(OrderFragment.newInstance("0"));
//        fragmentList.add(OrderFragment.newInstance("1"));
//        fragmentList.add(OrderFragment.newInstance("3"));
        if (adapter == null) {
