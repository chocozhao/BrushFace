...
import com.yzf.king.ui.activitys.UploadIdCardFmActivity;
...
public class PUploadIdCardFm extends XPresent<UploadIdCardFmActivity> {
                ...
                .subscribe(new ApiSubcriber<UploadPhotosResult>() {
                    ...
                    public void onNext(UploadPhotosResult uploadPhotosResult) {
                        if (uploadPhotosResult.getCode() == ResultCode.SUCCESS.code()) {
                            ...
                            if (type.equals("01")) {
                                getV().setIdInfo(uploadPhotosResult.getData().getIdBean());
                            }
                        } else {
