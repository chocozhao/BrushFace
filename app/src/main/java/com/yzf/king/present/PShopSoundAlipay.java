...
import com.yzf.king.ui.activitys.ShopSoundAlipayActivity;
...
/**
 * ClaseName：PShopSoundAlipay
 * Description：
 * Author：chocozhao
 * QQ: 1027313530
 * Createtime：2019/8/20 20:01
 * Modified By：
 * Fixtime：2019/8/20 20:01
 * FixDescription：
 **/

public class PShopSoundAlipay extends XPresent<ShopSoundAlipayActivity> {

    /**
     * 上传资料
     */
    public void addShopInfo(String merchId, String shopId, String transType, String status,String alipayId) {
        String version = Version.ADDSHOPINFO.version();
        Api.getAPPService().addShopInfo(merchId, shopId, transType, status, null, null, null, null, null,
                null, null, null, null, null, null,
                null, null, null, null, null, null,
                null, null, null, null, null, null,
                null, null, null, null, null, null,
                null, null,alipayId, version)
