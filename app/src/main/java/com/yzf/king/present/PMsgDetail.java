...
import com.yzf.king.ui.activitys.MsgDetailActivity;
 ...
 * FixDescription：
 */
public class PMsgDetail extends XPresent<MsgDetailActivity> {
    ...
    public void updateMsg(GetPushMsgJGResults.DataBean item) {
        if (item.getMsgStatus() != null && item.getMsgStatus().equals("0")) {
            ...
            Api.getAPPService().updatePushMsg(merchId, id,"1" ,version)
