package com.yzf.king.widget.stepView;
...
import com.yzf.king.widget.stepView.item.StepNodeItemDecoration;
import com.yzf.king.widget.stepView.utils.ScreenUtils;
...
public class StepView extends RecyclerView {
    ...
    public StepView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        radius = (int) ta.getDimension(R.styleable.StepView_stepViewRadius, radius);
