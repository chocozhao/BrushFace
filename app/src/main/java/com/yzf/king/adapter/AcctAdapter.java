...
public class AcctAdapter extends SimpleRecAdapter<HomeSource, AcctAdapter.ViewHolder> {
    ...
    public int getLayoutId() {
        return R.layout.adapter_acct;
    }

    public AcctAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        viewHolder.itemView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (AcctAdapter.this.getRecItemClick() != null) {
                    AcctAdapter.this.getRecItemClick().onItemClick(i, homeSource, 0, viewHolder);
                }
            }
        });
    }
